                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="{{ old('min_order') }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="weight_unit" class="form-control">
                                                            <option value="gram"
                                                                {{ old('weight_unit') == 'gram' ? 'selected' : '' }}>Gram
                                                            </option>
                                                            <option value="kg"
                                                                {{ old('weight_unit') == 'kg' ? 'selected' : '' }}>Kilogram
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="status" class="form-control">
                                                            ...
                                                            <option value="unpublished"
                                                                ...
                                                                Unpublished</option>
                                                            <option value="block"
                                                                {{ old('status') == 'block' ? 'selected' : '' }}>Block
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-switch">
                                                        <input name="pre_order" value="on" type="checkbox"
                                                            class="custom-control-input" id="switchPreOrder"
                                                            {{ old('pre_order') == 'off' ? '' : 'checked' }}>
                                                ...
                                                <div class="form-group" id="pre_order_message">
                                                    ...
                                                    <textarea name="pre_order_message" id="editor2">{{ old('pre_order_message') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@push('addon-script')
    ...
    <script>
        $(document).ready(function() {
            if ($('input[name="pre_order"]').is(':checked')) {
            ...
            $('#switchPreOrder').on('change', function() {
                if ($(this).is(':checked')) {
                    ...
                    $(this).next().text('Off');
                    $('input[name="pre_order"]').val(''); // Mengubah value menjadi kosong
                    $('#pre_order_message').hide();
                }
            });

            var oldPreOrder = '{{ old('pre_order') }}';
            if (oldPreOrder == 'on') {

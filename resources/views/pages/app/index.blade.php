        ...
        <div class="content-wrap">
            <div class="container">
                ...
                <div id="oc-products" class="owl-carousel products-carousel carousel-widget" data-margin="20"
                    data-loop="false" data-autoplay="5000" data-nav="true" data-pagi="false" data-items-xs="1"
                                ...
                                <div class="product-image">
                                    ...
                                    <div class="bg-overlay">
                                        <div class="bg-overlay-content align-items-end justify-content-between"
                                            ...
                                            <a href="#" class="btn btn-dark" data-lightbox="ajax"><i
                                                    class="bi-heart"></i></a>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="demos/shop/images/sections/1-2.jpg" data-lightbox="image"><img
                                            src="/app/assets/demos/shop/images/sections/1-2.jpg" alt="Image"></a>
                                </div>

                                <div class="col-6">

                                    <a href="demos/shop/images/sections/1-3.jpg" data-lightbox="image"><img
                                            src="/app/assets/demos/shop/images/sections/1-3.jpg" alt="Image"></a>
                        ...
                        <div class="col-md-7 min-vh-50">
                            ...
                            <a href="https://www.youtube.com/watch?v=bpNcuh_BnsA" data-lightbox="iframe"
                                ...
                                <div class="vertical-middle text-center">
                                    ...
                                    <div class="play-icon"><i class="fa-solid fa-circle-play display-3 text-light"></i>
                                    </div>
                ...
                <div class="row col-mb-30">
                    @foreach ($product as $item)
                        <div class="col-lg-2 col-md-3 col-6 px-2">
                            <div class="product">
                                <div class="product-image">
                                    <a href="#"><img class="image-products"
                                            src="{{ Storage::url($item->thumbnail) }}" alt="Image 1"></a>
                                    {{-- <a href="#"><img src="/app/assets/demos/shop/images/items/new/1-1.jpg"
                                                alt="Image 1"></a> --}}
                                    <div class="sale-flash badge bg-danger p-2">Baru</div>
                                    <div class="bg-overlay">
                                        <div class="bg-overlay-content align-items-end justify-content-between"
                                            data-hover-animate="fadeIn" data-hover-speed="400">
                                            <a href="#" class="btn btn-dark me-2" title="Add to Cart"><i
                                ...
                                <div class="product-desc">
                                    <div class="product-title mb-1">
                                        <h3><a href="{{ route('product.detail', $item->slug) }}">{{ $item->name }}</a>
                                        </h3>
                                    </div>
                                    <div class="product-price font-primary">
                                        Rp. {{ number_format($item->price, 0, ',', '.') }}
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-12">
                            ...
                            <ul
                                ...
                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/1.png"
                                            alt="Clients"></a>
                                </li>

                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/2.png"
                                            alt="Clients"></a>
                                </li>

                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/3.png"
                                            alt="Clients"></a>
                                </li>

                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/4.png"
                                            alt="Clients"></a>
                                </li>

                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/5.png"
                                            alt="Clients"></a>
                                </li>

                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/6.png"
                                            alt="Clients"></a>
                                </li>

                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/7.png"
                                            alt="Clients"></a>
                                </li>

                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/8.png"
                                            alt="Clients"></a>
                                </li>

                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/9.png"
                                            alt="Clients"></a>
                                </li>

                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/10.png"
                                            alt="Clients"></a>
                                </li>

                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/11.png"
                                            alt="Clients"></a>
                                </li>

                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/12.png"
                                            alt="Clients"></a>
                                </li>

                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/13.png"
                                            alt="Clients"></a>
                                </li>
                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/14.png"
                                            alt="Clients"></a>
                                </li>
                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/15.png"
                                            alt="Clients"></a>
                                </li>
                                <li class="grid-item"><a href="#"><img src="/app/assets/images/clients/logo/16.png"
                                            alt="Clients"></a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="">
                        <div class="row">
                            ...
                            <div class="col-md-4 d-none d-md-flex align-items-end">
                                <img src="/app/assets/demos/shop/images/sections/app.png" alt="Image" class="mb-0">
                            </div>
                        </div>
                    </div>
                </div>
